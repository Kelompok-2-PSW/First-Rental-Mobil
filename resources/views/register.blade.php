...
<html lang="en">
  <head>
    ...
    <title>Registrasi-First Rental </title>
    <meta charset="utf-8" />
            ...
            <div class="login-wrap p-4 p-md-5">
              ...
              <form action="{{ route('simpanregister') }}" class="signup-form" method="POST">
                ...
                <div class="form-group mb-3">
                  ...
                  <input id="password-field" type="password" name="password_confirmation" class="form-control" placeholder="Konfirmasi Password" />
