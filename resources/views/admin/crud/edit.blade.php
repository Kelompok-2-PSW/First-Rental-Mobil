...
<hr />
<form method="POST" action="{{route('crud.update', $car->id_mobil)}}" enctype="multipart/form-data">
@csrf
<h5>No Mobil</h5>
<input type="text" name="no_mobil" id="no" placeholder="Masukkan nomor mobil" class="form-control" value="{{$car->no_mobil}}"><br>
<h5>Merk</h5>
<input type="text" name="merk" id="merk" placeholder="Masukkan merk mobil" class="form-control" value="{{$car->merk}}"><br>
<h5>Gambar</h5>
<input type="file" name="gambar" id="gambar" placeholder="Masukkan Nama Mobil yang akan di pesan" class="form-control"><br>
<h5>Harga</h5>
<input type="text" name="harga" id="harga" placeholder="Masukkan harga" class="form-control" value="{{$car->harga}}"><br>
<h5>STATUS</h5>
